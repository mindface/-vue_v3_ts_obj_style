...
export const state = () => ({
  viewFieldId: 1,
  clientData: [
    {id: 1,name: "山田太郎",level:'improvement',body:"自己紹介自己紹介自己紹介自己紹介自己紹介自己紹介"},
    {id: 2,name: "山田太郎",level:'improvement',body:"自己紹介自己紹介"},
    {id: 3,name: "山田太郎",level:'improvement',body:"自己紹介自己紹介自己紹介自己紹介自己紹介自己紹介"},
    {id: 4,name: "山田太郎",lsevel:'improvement',body:"自己紹介自己紹介自己紹介自己紹介"},
    {id: 5,name: "山田太郎",level:'improvement',body:"自己紹介自己紹介"}
  ],
  fieldItems: [
    {
      slug: 'customize',
      ...
      clientarticle: [
        {
          ...
          body: '計画を解決できない場合は、図にしてプロセス化してフローを確認する。',
          category: "join",
          articles_id: 2,
          user_id: 2,
        },
