<template>
  <div class="dialog-view">
    <div v-if="viewBtn">
      <el-button type="text" @click="dialogFormVisible = true">記録追加</el-button>
    </div>
...
export default Vue.extend({
    ...
    methods: {
      sendDataAction(){
        ...
        this.$accessor.memoryData.postMemoryAction(sendData)
        this.title = ''
        this.textarea = ''
        this.category = ''
      ...
      updateDataAction(){
        ...
        this.$accessor.memoryData.updateMemoryAction(sendData)
        this.title = ''
        this.textarea = ''
        this.category = ''
        this.dialogFormVisible = false
